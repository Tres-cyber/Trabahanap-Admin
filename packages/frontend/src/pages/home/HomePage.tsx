    ...
    <MainLayout>
      <div className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-2xl font-semibold text-gray-900">567</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-2xl font-semibold text-gray-900">2,345</dd>
                  </dl>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
          ...
          {/* Users Chart */}
          <div className="bg-white shadow rounded-lg p-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Monthly Users</h3>
